...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost:8888/dfb-portfolio/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Images options.
	imgSRC: '/Applications/MAMP/htdocs/dfb-portfolio/img', // Source folder of images which should be optimized and watched. You can also specify types e.g. raw/**.{png,jpg,gif} in the glob.
